                ...
                <div className='contrainer-fluid bg-linear'>
                    ...
                    <div className="section-2 d-flex justify-content-center">
                        <div className="wallet bg-white d-flex align-items-center justify-content-between px-4 py-2">
                            ...
                            <a className='btn d-flex align-items-center justify-content-center' style={{ color: "#009EDB", fontSize: "15px", background: "none", border: "none" }} aria-current="page" href="history">
                                <b className='ms-2'>History</b>
                            </a>

                            <a className='btn d-flex align-items-center justify-content-center' style={{ color: "#009EDB", fontSize: "15px", background: "none", border: "none" }} aria-current="page" href="topup">
                                <b className='ms-2'>Top Up</b>
                            </a>
